...
from src.ansatz import noiseless_ansatz, noisy_ansatz_bigT
...
class IndirectVQE:
    ...
    def create_ansatz(self, param: List[float]) -> QuantumCircuit:
        ...
        if self.run == "vqe-bigT-simulation-with-noise":
            self.ansatz = noisy_ansatz_bigT(
                nqubits=self.nqubits,
    ...
    def run_vqe(self) -> Dict:
        ...
        vqe_result: Dict = {
            ...
            "trotter_details": self.ansatz.get("trotter_details", None),
        }
